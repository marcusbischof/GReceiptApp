angular.module('greceipt.service.auth', ['greceipt.utils'])
    .service('authService', function($rootScope, $q, $http, $_, $localstorage) {
        ...
        this.signin = function(user) {
            ...
            var loginGReceiptWebService = function(uname, pword) {
              // console.log("uname --> ", uname);
              // console.log("pword --> ", pword);
              $http({
                  method:"POST",
                  url:"http://dev.worlddd.net/gr/login.php",
                  ...
                  data: {
                    ...
                    "password": pword
                        ...
                        // success
                        console.log("success");
                        $rootScope["user_id_webservice"] = response.data.id;
                        console.log("root scope in auth service is --> " , $rootScope);
                        console.log("response in auth service is --> " , response);
                },
              ...
              // function(response) { // optional
              //         // failed
              //         console.log("helooooooppppp");
              //         console.log(response);
              // });
            }

            loginGReceiptWebService(user.email, user.password);
